...
export default function WhyChooseAndFAQ() {
  ...
  return (
    <section className="py-20 bg-[#050A44] text-white">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            {/* CTA Button */}
            <button onClick={() => router.push('/get-quote')} className="bg-primary hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors">
              Get Quote
            </button>
          </div>
