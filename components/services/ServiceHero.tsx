...
export default function ServiceHero({ title, description, quoteParam }: ServiceHeroProps) {
  return (
    <section className="w-full bg-white py-33 px-6 mt-4">
      <div className="max-w-7xl mx-auto text-center">
              <AnimatedSectionHeading className="text-5xl md:text-6xl bg-linear-to-br from-primary to-blue-400 text-transparent bg-clip-text font-bold mb-6 py-2">
        {title}
