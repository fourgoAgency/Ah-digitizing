        ...
        <div className="lg:col-span-2">
          <div className="relative flex items-center">
            ...
            <div className="absolute right-6 bottom-6 flex gap-4">
              <button onClick={prev} aria-label="Previous" className="w-12 h-12 rounded-full cursor-pointer bg-blue-700 bg-opacity-80 flex items-center justify-center hover:bg-opacity-100 transition">
              ...
              <button onClick={next} aria-label="Next" className="cursor-pointer w-12 h-12 rounded-full bg-blue-700 bg-opacity-80 flex items-center justify-center hover:bg-opacity-100 transition">
