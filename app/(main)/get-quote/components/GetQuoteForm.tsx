...
const selectedOutputFormatLookup = useMemo(
  ...
  useEffect(() => {
    ...
    if (placementArea) {
      ...
      const matched = placementAreas.find((area) => area.toLowerCase().replace(/\s+/g, "-") === slug);
  ...
  }, [availableOutputFormats, emitFieldChange, onFieldChangeAction, onOutputFormatToggleAction, searchParams]);
